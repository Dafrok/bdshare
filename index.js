(function (global, factory) {
  ...
  var cmdList = ['qzone', 'weixin', 'tsina', 'baidu', 'renren', 'tqq', 'kaixin001', 'tqf', 'hi', 'douban', 'tsohu', 'msn', 'qq', 'thx', 'taobao', 'tieba', 'buzz', 'sohu', 't163', 'qy', 'meilishuo', 'mogujie', 'diandian', 'huaban', 'leho', 'share189', 'duitang', 'hx', 'tfh', 'fx', 'tuita', 'ff', 'wealink', 'youdao', 'xg', 'ty', 'fbook', 'twi', 'ms', 'deli', 's139', 's51', 'zx', 'linkedin', 'copy'];
